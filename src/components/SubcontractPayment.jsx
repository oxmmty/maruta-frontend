...
import { Form, Tabs, Select, Input, Radio, Typography } from "antd";

const { Text } = Typography;

const SubcontractPaymentTab = ({ setSubPayData, editData }) => {
    ...
    <div>
      ...
      <div className="flex flex-wrap flex-row items-center gap-x-4">
        <Form.Item label={"車番1"} className="grow">
          ...
          /> */}
          {/* <Select
            options={driverData.map(driver => ({ label: driver, value: driver }))}
            // onChange={(value) => setSelfTruckNumber1(value)}
            onChange={(value) => {
              if (driver1 === false) {
                setTruckNumber1(value);
                setSelfTruckNumber1(null);
              } else {
                setSelfTruckNumber1(value);
                setTruckNumber1(null);
              }
            }}
          /> */}
...
const SubcontractPayment = (
  ...
  const dialogComponent = [
    <SubcontractPaymentTab
      key={1}
      setSubPayData={setSubPayData1}
      editData={editData}
    />,
    <SubcontractPaymentTab
      key={2}
      setSubPayData={setSubPayData2}
      editData={editData}
    />,
    <SubcontractPaymentTab
      key={3}
      setSubPayData={setSubPayData3}
      editData={editData}
    />,
    <SubcontractPaymentTab
      key={4}
      setSubPayData={setSubPayData4}
      editData={editData}
    />,
    <SubcontractPaymentTab
      key={5}
      setSubPayData={setSubPayData5}
      editData={editData}
    />,
    <SubcontractPaymentTab
      key={6}
      setSubPayData={setSubPayData6}
      editData={editData}
    />,
  ];
  return (
